 ...
 * generated in the com.certificatic.ws package. 
...
public class ObjectFactory {
    ...
    private final static QName _Dividir_QNAME = new QName("http://ws.certificatic.com/", "dividir");
    private final static QName _DividirResponse_QNAME = new QName("http://ws.certificatic.com/", "dividirResponse");
    private final static QName _Multiplicar_QNAME = new QName("http://ws.certificatic.com/", "multiplicar");
    private final static QName _Restar_QNAME = new QName("http://ws.certificatic.com/", "restar");
    private final static QName _Sumar_QNAME = new QName("http://ws.certificatic.com/", "sumar");
    private final static QName _SumarResponse_QNAME = new QName("http://ws.certificatic.com/", "sumarResponse");
    private final static QName _MultiplicarResponse_QNAME = new QName("http://ws.certificatic.com/", "multiplicarResponse");
    private final static QName _RestarResponse_QNAME = new QName("http://ws.certificatic.com/", "restarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.certificatic.ws
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.certificatic.com/", name = "dividir")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.certificatic.com/", name = "dividirResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.certificatic.com/", name = "multiplicar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.certificatic.com/", name = "restar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.certificatic.com/", name = "sumar")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.certificatic.com/", name = "sumarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.certificatic.com/", name = "multiplicarResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://ws.certificatic.com/", name = "restarResponse")
